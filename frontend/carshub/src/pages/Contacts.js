...
const Contacts = () => {
  ...
  const handleSubmit = async(e) => {
    e.preventDefault();
    try{
      await axios.post('http://localhost:5000/contacts',{fullname,email,phoneno,subject,msg})
                    ...
                    <form method='post' onSubmit={handleSubmit}>
                      <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                        <div class="col-12">
                          ...
                          <input type="text" class="form-control" id="fullname" name="fullname"  onChange={(e)=>{setFullname(e.target.value)}} />
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <div class="input-group">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone"  onChange={(e)=>{setPhoneno(e.target.value)}} />
                          </div>
                        </div>
                        <div class="col-12">
                          <label for="subject" class="form-label">Subject <span class="text-danger">*</span></label>
                          <input type="text" class="form-control" id="subject" name="subject"  onChange={(e)=>{setSubject(e.target.value)}} />
                        </div>
                        <div class="col-12">
                          <label for="message" class="form-label">Message <span class="text-danger">*</span></label>
                          <textarea class="form-control" id="message" name="message" rows="3" onChange={(e)=>{setMsg(e.target.value)}} ></textarea>
                        </div>
                        <div class="col-12">
                          <div class="d-grid">
                            <button class="btn btn-outline-primary btn-lg" type="submit">Send Message</button>
                          </div>
                        </div>
                      </div>
                    </form>
                    ...
                    <div class="col-12 col-xl-11">
                      <div class="mb-4 mb-md-5">
                        ...
                        <div>
                          ...
                          <address class="m-0 text-secondary">Ahmedabad,serkhej,Gujrat</address>
                        </div>
                      </div>
                        ...
                        <div class="col-12 col-sm-6">
                          <div class="mb-4 mb-sm-0">
                            ...
                            <div>
                              ...
                              <p class="mb-0">
                                <a class="link-secondary text-decoration-none" href="tel:+15057922430">+91 1234567890</a>
                              </p>
                            </div>
                          </div>
                        </div>
                        <div class="col-12 col-sm-6">
                          <div class="mb-4 mb-sm-0">
                            ...
                            <div>
                              ...
                              <hr class="w-75 mb-3 border-dark-subtle"/>
                              <p class="mb-0">
                                <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">carshub@gmail.com</a>
                              </p>
                            </div>
                          </div>
                        </div>
